...
Assuming the number is more or equal to zero then by using "print" give a command of typing a number more than 0 or else print that includes "please type a number next time". Quit

Now consider , guess user_guess = ("make a guess")
